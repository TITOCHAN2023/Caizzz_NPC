...
from middleware.podcastfy.content_generator import ContentGenerator
from middleware.podcastfy.utils.config import Config, load_config
from middleware.podcastfy.utils.config_conversation import load_conversation_config
...
""" logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('middleware.podcastfy.log'),  # Save to file
